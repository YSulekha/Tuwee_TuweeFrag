...
public class FragmentTweetsListBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.timeline_recycler, 1);
    }
    // views
    public final android.support.v4.widget.SwipeRefreshLayout swipeContainer;
    public final android.support.v7.widget.RecyclerView timelineRecycler;
    // variables
    // values
    // listeners
    ...
    public FragmentTweetsListBinding(android.databinding.DataBindingComponent bindingComponent, View root) {
        ...
        this.swipeContainer = (android.support.v4.widget.SwipeRefreshLayout) bindings[0];
        this.swipeContainer.setTag(null);
        this.timelineRecycler = (android.support.v7.widget.RecyclerView) bindings[1];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static FragmentTweetsListBinding inflate(android.view.LayoutInflater inflater, android.view.ViewGroup root, boolean attachToRoot, android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<FragmentTweetsListBinding>inflate(inflater, com.codepath.apps.tweet.R.layout.fragment_tweets_list, root, attachToRoot, bindingComponent);
    }
    ...
    public static FragmentTweetsListBinding inflate(android.view.LayoutInflater inflater, android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.codepath.apps.tweet.R.layout.fragment_tweets_list, null, false), bindingComponent);
    }
